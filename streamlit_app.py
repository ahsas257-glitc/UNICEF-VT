...
Embeds the self-contained HTML dashboard (latest data baked into dashboard.html).
...
# The dashboard is rendered inside an iframe, so embed the local logo directly.
